...
void WidgetTestItem::connect_init()
{
    ...
    connect(this, SIGNAL(signal_sample_deviceSN()), testControl, SLOT(slot_sample_deviceSN()));
    connect(testControl, SIGNAL(signal_update_deviceSN(QString)), this, SLOT(slot_update_deviceSN(QString)));
    connect(testControl, SIGNAL(signal_update_fixtureSN(QString)), this, SLOT(slot_update_fixtureSN(QString)));
